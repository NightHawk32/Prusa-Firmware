...
#define EEPROM_TMC2130_SG_THRS_X (EEPROM_ECOOL_ENABLE-2) //uint8_t
#define EEPROM_TMC2130_SG_THRS_Y (EEPROM_TMC2130_SG_THRS_X-2) //uint8_t
#define EEPROM_TMC2130_SG_THRS_Z (EEPROM_TMC2130_SG_THRS_Y-2) //uint8_t
#define EEPROM_TMC2130_SG_THRS_E (EEPROM_TMC2130_SG_THRS_Z-2) //uint8_t

//This is supposed to point to last item to allow EEPROM overrun check. Please update when adding new items.
#define EEPROM_LAST_ITEM EEPROM_TMC2130_SG_THRS_E
// !!!!!
