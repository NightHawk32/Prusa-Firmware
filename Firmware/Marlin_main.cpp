...
//	lang_reset();
  ...
  update_current_firmware_version_to_eeprom();
	...
	tmc2130_sg_thr[X_AXIS] = eeprom_read_byte((uint8_t*)EEPROM_TMC2130_SG_THRS_X);
	tmc2130_sg_thr[Y_AXIS] = eeprom_read_byte((uint8_t*)EEPROM_TMC2130_SG_THRS_Y);
	tmc2130_sg_thr[Z_AXIS] = eeprom_read_byte((uint8_t*)EEPROM_TMC2130_SG_THRS_Z);
	tmc2130_sg_thr[E_AXIS] = eeprom_read_byte((uint8_t*)EEPROM_TMC2130_SG_THRS_E);
