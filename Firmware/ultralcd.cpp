...
#ifdef TMC2130
static void lcd_stallguard_menu_save(void)
{
	eeprom_update_word((uint16_t*)EEPROM_TMC2130_SG_THRS_X, tmc2130_sg_thr[X_AXIS]);
    eeprom_update_word((uint16_t*)EEPROM_TMC2130_SG_THRS_Y, tmc2130_sg_thr[Y_AXIS]);
    eeprom_update_word((uint16_t*)EEPROM_TMC2130_SG_THRS_Z, tmc2130_sg_thr[Z_AXIS]);
    eeprom_update_word((uint16_t*)EEPROM_TMC2130_SG_THRS_E, tmc2130_sg_thr[E_AXIS]);
}

static void lcd_stallguard_menu(void)
{
MENU_BEGIN();
ON_MENU_LEAVE(
	lcd_stallguard_menu_save();
);
MENU_ITEM_BACK_P(_T(MSG_HW_SETUP));
MENU_ITEM_EDIT_int3_P(_i("Thr X"), &tmc2130_sg_thr[X_AXIS], 0, 63);
MENU_ITEM_EDIT_int3_P(_i("Thr Y"), &tmc2130_sg_thr[Y_AXIS], 0, 63);
MENU_ITEM_EDIT_int3_P(_i("Thr Z"), &tmc2130_sg_thr[Z_AXIS], 0, 63);
MENU_ITEM_EDIT_int3_P(_i("Thr E"), &tmc2130_sg_thr[E_AXIS], 0, 63);
MENU_END();
}
#endif //TMC2130
...
#ifdef TMC2130
	MENU_ITEM_SUBMENU_P(_i("Stallguard"), lcd_stallguard_menu);
#endif //TMC2130
